...
export class FeaturesController {
  ...
  @Patch('me') updateMe(@Req() r: any, @Body() b: any) {
    return this.f.updateMe(r.user.id, b);
  }
  @Put('profile') profile(@Req() r: any, @Body() b: any) {
  ...
  @Get('matches') matches(@Req() r: any) {
    return this.f.matches(r.user.id);
  }
  @Get('likes') likes(@Req() r: any) {
    return this.f.likes(r.user.id);
  }
  @Delete('matches/:id') unmatch(@Req() r: any, @Param('id') id: string) {
  ...
  @Get('conversations') conversations(@Req() r: any) {
  ...
  @Get('notifications') notifications(@Req() r: any) {
  ...
  @Post('blocks/:userId') block(@Req() r: any, @Param('userId') id: string) {
  ...
  @Patch('password') password(@Req() r: any, @Body() b: { password: string }) {
    return this.f.changePassword(r.user.id, b.password);
  }
  @Get('admin/dashboard') dashboard(@Req() r: any) {
    this.f.ensureAdmin(r.user);
    return this.f.dashboard();
  }
  @Get('admin/users') users(@Req() r: any) {
    this.f.ensureAdmin(r.user);
  ...
  @Get('admin/reports') reports(@Req() r: any) {
    this.f.ensureAdmin(r.user);
    return this.f.reports();
  }
  @Get('admin/config') config(@Req() r: any) {
    this.f.ensureAdmin(r.user);
